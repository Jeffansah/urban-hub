      ...
      <div className="w-full max-w-5xl text-white flex items-center justify-between max-lg:px-5">
        ...
        >
          ...
          <div
            className={`${
              !isOpen && "hidden"
            } fixed top-0 left-0 w-screen h-screen bg-white z-[100] overflow-auto text-black pb-16 scrollbar-hide scroll-smooth`}
          >
            ...
            <div className="flex flex-col w-full px-6 mt-10">
              ...
              <div className="mt-5">
                <div className="flex gap-2.5 mb-5 font-light text-xs items-center">
                  <p className="font-[400]">USD</p>
                  <p>United States Dollar</p>
                </div>
                <div className="flex gap-2.5 mb-5 font-light text-xs items-center">
                  <img
                    src="https://i.ibb.co/PDwM1YZ/united-kingdom.png"
                    alt="uk"
                    className="w-6 h-6"
                  />
                  <p>English (UK)</p>
                </div>
                <div className="flex gap-2.5 mb-5 font-light text-xs items-center cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <div className="flex gap-2.5 font-light text-xs items-center mb-6 cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                  ...
                  <p>Manage Travel Coins</p>
                </div>
              </div>
              <h2 className="text-xs font-semibold mb-4">Account</h2>
              <div className="flex gap-2.5 font-light text-xs items-center mb-4 cursor-pointer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <h2 className="text-xs font-semibold mb-4">Help and support</h2>
              <div className="flex gap-2.5 font-light text-xs items-center mb-4 cursor-pointer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <h2 className="text-xs font-semibold mb-4">Company and Legal</h2>
              <div className="flex gap-2.5 font-light text-xs items-center mb-4 cursor-pointer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
